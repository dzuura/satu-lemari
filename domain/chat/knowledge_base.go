...
func GetKnowledgeBase() []KnowledgeBase {
	return []KnowledgeBase{
		...
		},
		{
			...
			Answer: "Pakaian yang dapat didonasikan harus dalam kondisi: Excellent (seperti baru), Good (sedikit bekas pakai), atau Fair (masih layak pakai). Tidak menerima pakaian yang rusak, kotor, atau tidak layak pakai.",
			Keywords: []string{"kondisi", "excellent", "good", "fair", "layak", "rusak"},
		},
...
func GetChatSuggestions() ChatSuggestionsResponse {
	return ChatSuggestionsResponse{
		...
		Categories: []string{"donation", "rental", "items", "education", "platform"},
	}
}
